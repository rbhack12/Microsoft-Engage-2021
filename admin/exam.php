...
<div class="card">
	...
	<div class="card-body">
		<div class="table-responsive">
			<table id="table_exam" class="table table-bordered table-striped table-hover">
				<thead>
					<tr>
						<th>Exam Name</th>
						<th>Date-Time</th>
    	...
    	<form method="post" id="form_exam">
      		<div class="modal-content">
        		...
        		<div class="modal-body">
          			...
          			<div class="form-group">
            			<div class="row">
              				<label class="col-md-4 text-right">Marking <span class="text-danger">*</span></label>
	              			<div class="col-md-8">
	                			<select name="marks_per_right_answer" id="marks_per_right_answer" class="form-control">
	                				...
	                				<option value="50">+50 Mark</option>
	                			</select>
	                		</div>
            			</div>
          			</div>
...
<div class="modal" id="deleteModal">
  	<div class="modal-dialog">
    	<div class="modal-content">
      		...
      		<!-- Modal body -->
      		<div class="modal-body">
        		<h3 align="center">Please confirm to delete the exam</h3>
      		</div>
    	...
    	<form method="post" id="question_form">
      		<div class="modal-content">
        		...
        		<div class="modal-body">
          			...
          			<div class="form-group">
            			<div class="row">
              				<label class="col-md-4 text-right">1st Option <span class="text-danger">*</span></label>
	              			<div class="col-md-8">
          			...
          			<div class="form-group">
            			<div class="row">
              				<label class="col-md-4 text-right">2nd Option <span class="text-danger">*</span></label>
	              			<div class="col-md-8">
          			...
          			<div class="form-group">
            			<div class="row">
              				<label class="col-md-4 text-right">3rd Option <span class="text-danger">*</span></label>
	              			<div class="col-md-8">
          			...
          			<div class="form-group">
            			<div class="row">
              				<label class="col-md-4 text-right">4th Option <span class="text-danger">*</span></label>
	              			<div class="col-md-8">
