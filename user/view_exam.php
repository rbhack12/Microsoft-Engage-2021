...
?>
<div class="row" style=style="background-color:white;">
	<div class="col-md-8">
		<div class="card">
...
$(document).ready(function(){
	...
	setInterval(function(){
		...
		{
			//
			location.href="enroll_exam.php?gotover=success";
			...
			<div class="table-responsive">
				<table class="table table-bordered table-hover">
					...
					foreach($result as $row)
					{
						...
						if($row['marks'] == '0')
						{
							$question_result = '<h4 class="badge badge-dark">Not Attended</h4>';
						}
